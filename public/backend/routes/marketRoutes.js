...
// per rifiutare una proposta di trade
router.post('/trade/reject', authMiddleware, rejectTrade);

// per accettare una proposta di trade
router.post('/trade/accept', authMiddleware, acceptTrade);
